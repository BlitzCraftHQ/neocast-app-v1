    ...
    <footer id="contact" className="bg-white">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <div className="mt-12 max-w-2xl text-xl sm:text-2xl mx-auto text-center font-semibold text-zinc-500">
          Building NeoCast has been an incredibly fun effort across many people
          at NeoCast and our frens at other companies. We&apos;re always looking
          to make NeoCast better, so please let us know how we can improve.
        </div>
